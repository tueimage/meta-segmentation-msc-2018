...
def main():
    ...
    #tasks_list= ['Task05_Prostate', 'Task06_Lung', 'Task07_Pancreas','Task01_BrainTumour','Task02_Heart','Task03_Liver','Task04_Hippocampus', 'Task05_Prostate']
    ...
    for task in tasks_list:
        ...
        for fe in feature_extractors:
            ...
            model_json = struct.model.to_json()
            with open("architecture_{}.json".format(fe), "w") as json_file:
                json_file.write(model_json)
            struct.train(data.train_data, data.train_data, data.imageDimensions, verbosity = 1)
            struct.save_model()
