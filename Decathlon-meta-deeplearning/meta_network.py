from utils import meta_generator_OM
...
class meta_learner():
    ...
    def train(self, train_data, train_labels, imageDimensions, verbosity):
        self.history = self.model.fit_generator(meta_generator_OM(train_data, train_labels, self.minibatch_size, imageDimensions), steps_per_epoch = 10, nb_epoch = self.epochs, verbose = verbosity)
    def save_model(self):
        print("---SAVING MODEL---")
